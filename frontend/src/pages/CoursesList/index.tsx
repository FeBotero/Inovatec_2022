...
export function CoursesList() {
  ...
  const HCJa =
    "Essas três ferramentas dominam o desenvolvimento web. Cada biblioteca ou ferramenta parece estar centrada em HTML, CSS e JS. Então, se você quer se tornar um desenvolvedor web, você precisa aprendê-los bem.";
  const Cl =
    ...
    <Container>
      <Extern>
        <div>
          <h1>Cursos</h1>
          <p>
            Nosso cursos foram desenvolvidos para facilitar a dinamica entre
            tutor e aluno, de forma que seja impulsionado pela gamificação.
          </p>
          <h2>Cursos disponiveis</h2>
          <ul>
            <li>
              <button onClick={() => setShowcourse(JS)}>
                <img src={Alg} alt="Algoritmo" />
                Algoritmo
              </button>
            </li>
            <li>
              <button onClick={() => setShowcourse(IntLogic)}>
                <img src={IntLog} alt="" />
                Introdução a Logica
              </button>
            </li>
            <li>
              <button onClick={() => setShowcourse(HCJa)}>
                <img src={HCJ} alt="HTML, CSS e Javascript" />
                HTML, CSS e Javascript
              </button>
            </li>
            <li>
              <button onClick={() => setShowcourse(Cl)}>
                <img src={C} alt="C" />C
              </button>
            </li>
            <li>
              <button onClick={() => setShowcourse(Cplus)}>
                <img src={Cs} alt="C++" />
                C++
              </button>
            </li>
            <li>
              <button onClick={() => setShowcourse(bds)}>
                <img src={bd} alt="Banco de Dados" />
                Banco da dados
              </button>
            </li>
          </ul>
        </div>
        <Content>{showCourse}</Content>
      </Extern>
    </Container>
  );
}
